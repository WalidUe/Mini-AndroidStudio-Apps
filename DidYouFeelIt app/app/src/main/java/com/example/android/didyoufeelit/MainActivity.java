...
public class MainActivity extends AppCompatActivity {
    ...
    private class EarthquakeAsyncTask extends AsyncTask<String, Void, Event>{
         ...
         *
         * It is NOT okay to update UI from a background thread, so we just return an
        ...
        protected Event doInBackground(String... urls)
        {
            ...
            Event earthquakeEvent = Utils.fetchEarthquakeData(urls[0]);
         ...
         *
         * It is okay to modify the UI within this method, we take {@link Event } object
